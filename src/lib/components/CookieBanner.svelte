<script>
    ...
    export let heading = "Configuração de cookies";
    export let description =
        "Usamos cookies para oferecer uma melhor experiência de navegação e analisar o tráfego do site. Ao clicar em aceitar, você concorda com nossa política de privacidade e uso de cookies.";
    ...
    const choicesDefaults = {
        necessary: {
            ...
            description:
                "Usado para controle de cookies. Não pode ser desligado.",
            value: true,
        },
        // tracking: {
        ...
        analytics: {
            ...
            description:
                "Usado para controlar o Google Analytics, uma ferramenta de terceiros oferecida pelo Google para rastrear o comportamento do usuário.",
            value: true,
        },
        // marketing: {
    ...
    export let acceptLabel = "Aceitar Todos";
    export let rejectLabel = "Reject cookies";
    export let settingsLabel = "Configurações";
            ...
            {#each choicesArr as choice}
                {#if Object.hasOwnProperty.call(choicesMerged, choice.id) && choicesMerged[choice.id]}
                    ...
                    >
                        ...
                        />
                        <label for={`gdpr-check-${choice.id}`}
                            >{choice.label}</label
                        >
