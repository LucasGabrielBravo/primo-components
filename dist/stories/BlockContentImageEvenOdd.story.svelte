<script>import BlockContentImageEvenOdd from "../components/blocks/blockContent/BlockContentImageEvenOdd.svelte";
export let Hst;
...
<Hst.Story title="BlockContentImageEvenOdd">
    <BlockContentImageEvenOdd {conteudos} {subtitulo} {titulo} {toptitulo} />
