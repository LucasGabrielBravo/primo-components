<script lang="ts">
    import BlockContentImageCol from "$lib/components/blocks/blockContent/BlockContentImageCol.svelte";
    ...
    let toptitulo = "toptitulo";
    let titulo = "Titulo";
    let subtitulo = "subtitulo";

    let conteudos: IConteudo[] = [
        {
            titulo: "Lorem Ipsum",
...
<Hst.Story title="BlockContentImageCol">
    <BlockContentImageCol {conteudos} {subtitulo} {titulo} {toptitulo} />
