      ...
      <div class="contato">
        <div class="botoes">
          <div class="telefone">
            ...
            <a
              href="tel:{telefone.url}"
              class="ligue-text"
              data-key="telefone.url"
            >
              <span class="ligue-chamada" data-key="liguechamada">
                {ligueChamada}
              </span>
              <span class="ligue-numero" data-key="telefone.label">
                {telefone.label}
              </span>
            </a>
          </div>
...
<style>
  ...
  .ligue {
    ...
    --tw-ring-opacity: 1;
    --tw-ring-color: rgb(var(--color-primary-600, 37 99 235) / var(--tw-ring-opacity))
}
  .ligue-chamada {
    font-weight: 400;
    --tw-text-opacity: 1;
